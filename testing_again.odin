...
HI :: ^struct {
	str: cstring,
	hi: Hello,
	SOME_ENUM_PROC: proc "c" () -> SOME_ENUM,
}
...
INT_PROC :: distinct [2][3][2]proc "c" (^_c_.int, Hello, HelloPtr) -> ^_c_.int
...
* IT'S AMAZING !!??!?!?!?!??!?!?!?
*/
SOME_PROC :: distinct ^proc "c" (^ { b: _c_.int, }) -> ^^^rawptr
...
foreign __LIB__ {
	...
	func3 :: proc(ADD: proc "c" (_c_.int, _c_.int) -> _c_.int, SUB: proc "c" (_c_.int, _c_.int) -> _c_.int) --- 
}
